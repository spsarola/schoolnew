...
{	
	...
	if($StudentName=="" || $Mobile=="" || $FatherName=="" || $MotherName=="" || $DOR=="" || $SectionId=="" || $Gender=="" || $SSSMID=="" || $Family_SSSMID=="" || $Aadhar_No=="" || $Bank_Account_Number=="" || $IFSC_Code=="")
	{
		$Message="All the fields are mandatory!!";
		$Type="error";
	}
	...
	else
	{
		...
		$query1="insert into registration(StudentsPassword,ParentsPassword,StudentName,FatherName,MotherName,DOR,Gender,SectionId,Mobile,Status,DOE,Session,Username,SSSMID,Family_SSSMID,Aadhar_No,Bank_Account_Number,IFSC_Code) values
			('$StudentsPassword','$ParentsPassword','$StudentName','$FatherName','$MotherName','$DOR','$Gender','$SectionId','$Mobile','NotAdmitted','$DOE','$CURRENTSESSION','$USERNAME','$SSSMID','$Family_SSSMID','$Aadhar_No','$Bank_Account_Number','$IFSC_Code') ";
		mysqli_query($CONNECTION,$query1);
